<template>
	<div>
		...
		<section>
			<img src="http://ugc.cdn.qianqian.com/yinyueren/pic/a7a7679d153b22452c0c82d0cfad5d3f.jpg" alt="">
			<div class="left">
...
<style scoped>
	section{width: 100%;overflow: hidden;margin-top: 2px;}
	img{width: 60px;float: left;}
	h4{font-weight: normal;font-size: 14px;margin-top: 8px;}
	section p{font-size: 12px; color: #444;}
	.left{float: left;margin-left: 8px;}
	.title{width: 100%;text-align: center;line-height: 30px;font-size: 16px;margin-bottom: 4px;}
</style>