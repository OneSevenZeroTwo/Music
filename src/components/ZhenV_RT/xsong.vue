			...
			<ul style="margin-bottom: 50px;">
				<li v-for="(n,index) in mylist" @click="setImg(n)" >
					<p>
						<b>{{n.name}}</b>
						<span>{{n.list}}</span>
						  <!--<mu-radio  name="group" nativeValue="simple4" v-model="value"  class="demo-checkbox" uncheckIcon="favorite_border" checkedIcon="favorite"/>-->
...
//			this.$store.getters.showPlay = false;
...
//					console.log(gaodu-window.scrollY);
					myimg.animate({top:gaodu},1000,function(){
						myimg.remove()
					})
