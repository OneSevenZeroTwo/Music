    ...
    <div>
        <div class="m_wrap">
            <div class="m_header" @click="">
                <a href="#/app/newSong" class="goback">&lt;返回</a> 账号注册
            ...
            <form id="register-form" name="pop-form-login" method="post">
                ...
                <mu-text-field label="注册帐号" hintText="请输入注册手机号码" v-model="telephone" labelFloat/>
                <br/>
                <mu-text-field label="昵称" hintText="请输入昵称" labelFloat/>
                <br/>
                <mu-text-field label="输入密码" hintText="请输入6-20位密码" type="password" labelFloat/>
                <br/>
                <mu-text-field label="确认密码" hintText="再次确认密码" type="password" labelFloat/>
                <br/>
                <div class="geetest">
                    <div class="gt_bg"></div>
                    <div>
